...
![ipa](/images/posts/ipa-fe/ipa.png)
...
後來發現自己直接啃書學習效益不大，推薦 YouTube 上 すーさん 的教學：
...
![OSI](/images/posts/ipa-fe/osi.png)
...
![TCP/IP](/images/posts/ipa-fe/tcp-ip.png)
...
{% note warning %}
【註記】A 和 B 幾乎必出的範圍，硬記文字其實幫助不大，建議搭配圖形幫助記憶，理解什麼情境適用排序法。
{% endnote %}
...
以上是我在準備 FE 基本情報技術者試驗過程中，實際使用到的資源整理與學習筆記，希望對同樣在準備這個考試的人有幫助。

如果只能給一個建議，那就是「別硬啃書」，先看影片建立試驗框架，善用過去問道場大量刷題，效率會高很多。

## 參考資料

+ [IPA 基本情報技術者試験（官方）](https://www.ipa.go.jp/shiken/kubun/fe.html)
+ [基本情報技術者過去問道場](https://www.fe-siken.com/fekakomon.php)
+ [【最新版】基本情報技術者試験の科目Aを12時間で完璧に理解（すーさん）](https://www.youtube.com/watch?v=oqaBEnhIxk0)
+ [【科目B】アルゴリズム問題をたった1動画で対策（すーさん）](https://youtu.be/wFpyeWto8Og?si=aierZ8TcbOJ-rhkV)
